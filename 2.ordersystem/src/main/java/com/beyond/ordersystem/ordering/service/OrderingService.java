...
public class OrderingService {
    ...
    private final SseAlfrmService sseAlfrmService;
    public OrderingService(OrderingRepository orderingRepository, OrderDetailRepository orderDetailRepository, ProductRepository productRepository, MemberRepository memberRepository, SseAlfrmService sseAlfrmService) {
        this.orderingRepository = orderingRepository;
        this.orderDetailRepository = orderDetailRepository;
        this.productRepository = productRepository;
        this.memberRepository = memberRepository;
        this.sseAlfrmService = sseAlfrmService;
    }
...
//        알림 db저장
        sseAlfrmService.sendMessage("admin@naver.com",email,message);
